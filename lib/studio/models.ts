// @ts-nocheck
// Auto-copied from Open-Generative-AI packages/studio/src/models.js - adapted for Vitrine-Ai
// Preserves t2iModels, i2iModels, t2vModels, i2vModels, lipsyncModels, v2vModels etc.
// stub modelCapabilities for Vitrine build

// Synced from the canonical Muapi schema_data.json catalog.
// stub imageSizing for Vitrine build
const T2I_DIMENSION_RATIOS = ['1:1','16:9','9:16','4:3','3:4']
const I2I_DIMENSION_RATIOS = ['1:1','16:9','9:16']
function getAspectRatioOptions(){ return T2I_DIMENSION_RATIOS }
function getMediaCapability(){ return {} }
...
export const t2iModels = [
  {
    ...
    "inputs": {
      "prompt": {
        "examples": [
          "A portrait of me in a modern living room. Change it so Iâ€™m dressed in 1950s attire with a polka-dot dress, while maintaining my face and hairstyle."
        ],
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        "examples": [
          "A futuristic studio bathed in radiant beams of shifting neon colors â€” cyan, magenta, amber, and emerald â€” that blend into surreal gradients across walls and objects. A crystal-like prism floats at the center, splitting light into vibrant chromatic waves that ripple outward, painting the scene in glowing, ever-changing hues."
        ],
        "description": "Text prompt describing the image.",
        "type": "string",
        "title": "Prompt",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        "examples": [
          "A massive floating temple forged from translucent sapphire glass hovers above a storm-lit ocean. Crystalline towers refract lightning into rainbow shards that scatter across the waves below. Gigantic chains made of glowing runes suspend the temple in the air as swirling storm clouds coil around it. Beneath the structure, a vortex of shimmering water spirals upward, feeding energy into the floating palace. Distant thunder illuminates the scene with cold blue flashes, casting dramatic shadows across the ocean surface. Ultra-cinematic fantasyâ€“sci-fi fusion, hyper-detailed textures, volumetric lighting, 8k clarity."
        ],
        "description": "Text prompt describing the image.",
        "type": "string",
        "title": "Prompt",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        "examples": [
          "A small round robot sitting at a cafÃ© table outdoors, holding a tiny cup of coffee with both hands. The robot has a simple white body, a glowing digital face showing a happy expression, and short stubby legs dangling from the chair. Morning sunlight casts soft shadows on the pavement, potted plants surround the cafÃ©, and steam gently rises from the coffee cup. Clean, minimal, cute, modern illustration style, bright colors, friendly mood."
        ],
        "description": "Text prompt describing the image.",
        "type": "string",
        "title": "Prompt",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        "examples": [
          "A small round robot sitting at a cafÃ© table outdoors, holding a tiny cup of coffee with both hands."
        ],
        "description": "Text prompt describing the image.",
        "type": "string",
        "title": "Prompt",
  ...
  },
  {
    ...
    "inputs": {
      ...
      "stylize": {
        ...
        "title": "Stylize",
        "name": "stylize",
        "description": "Controls how artistic the result is. Range: 0â€“1000. Lower = more literal, higher = more stylized.",
        "default": 100,
        "minValue": 0,
        "maxValue": 1000,
        "step": 10
      ...
      "chaos": {
        ...
        "title": "Chaos",
        "name": "chaos",
        "description": "Controls variation between the 4 images. Range: 0â€“100. Higher = more diverse.",
        "default": 0,
        "minValue": 0,
        "maxValue": 100,
        "step": 1
      ...
      "weird": {
        ...
        "title": "Weird",
        "name": "weird",
        "description": "Adds unconventional aesthetics. Range: 0â€“3000.",
        "default": 0,
        "minValue": 0,
        "maxValue": 3000,
        "step": 50
      ...
      "seed": {
        ...
        "title": "Seed",
        "name": "seed",
        "description": "Reproducibility seed. Range: 0â€“4294967295. Same seed + same prompt â‰ˆ similar result.",
        "default": 0,
        "minValue": 0,
        "maxValue": 4294967295,
        "step": 1
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        "examples": [
          "A small round robot sitting at a cafÃ© table outdoors, holding a tiny cup of coffee, soft morning light, cute illustration style."
        ],
        "description": "Text prompt describing the image.",
        "type": "string",
        "title": "Prompt",
  ...
  },
  {
    ...
    "inputs": {
      ...
      "prompt": {
        ...
        "title": "Prompt",
        "name": "prompt",
        "description": "Optional prompt to guide the extension. Reference images with @image2â€¦@image9, videos with @video1â€¦@video3 (the source video's last frame is always @image1)."
      },
      "images_list": {
        "type": "array",
  ...
  },
  {
    ...
    "inputs": {
      ...
      "prompt": {
        ...
        "description": "Optional prompt to guide the extension. Reference additional images with @image2â€¦@image9, videos with @video1â€¦@video3, and audio with @audio1â€¦@audio3 â€” the source video's last frame is always @image1.",
        "type": "string",
        "title": "Prompt",
        "name": "prompt"
      },
...

  {
    ...
    "inputs": {
      ...
      "duration": {
        ...
        "title": "Duration (seconds)",
        "name": "duration",
        "description": "Video duration in seconds (4â€“15).",
        "default": 5,
        "minValue": 4,
        "maxValue": 15,
        "step": 1
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "title": "Prompt",
        "name": "prompt",
        "description": "Text description of the video to generate. Use @character:<id> to anchor the video to a Seedance 2 character â€” automatically switches to image-to-video mode.",
        "examples": [
          "A cinematic shot of a futuristic city at night with neon lights reflecting on wet streets."
        ]
      },
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "title": "Prompt",
        "name": "prompt",
        "description": "Text description of the video to generate. Use @character:<id> to anchor the video to a Seedance 2 character â€” automatically switches to image-to-video mode. Use @omni-character:<char_id> for a trained Kinovi character.",
        "examples": [
          "A cinematic shot of a futuristic city at night with neon lights reflecting on wet streets."
        ]
      },
  ...
  },
  {
    ...
    "inputs": {
      ...
      "seed": {
        ...
        "title": "Seed",
        "name": "seed",
        "description": "Random seed (0â€“2147483647). Fix for reproducibility; results may still vary due to model stochasticity.",
        "minValue": 0,
        "maxValue": 2147483647,
        "default": 0
      },
  ...
  },
  {
    ...
    "inputs": {
      ...
      "duration": {
        ...
        "title": "Duration",
        "name": "duration",
        "description": "Duration of the generated video in seconds (3â€“15).",
        "default": 5,
        "minValue": 3,
        "maxValue": 15,
        "step": 1
...
// Auto-generated from schema_data.json â€” Image to Image models
export const i2iModels = [
  ...
  },
  {
    ...
    "inputs": {
      "rotate_right_left": {
        "type": "int",
        "title": "Rotate Right-Left (degreesÂ°)",
      ...
      "vertical_angle": {
        "type": "int",
        "title": "Vertical Angle (Bird â¬„ Worm)",
        "name": "vertical_angle",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "description": "Text prompt describing the image.",
        "examples": [
          "Replace the central spherical chronometer with a floating crystalline lotus emitting soft golden light, keep the asteroid chamber, star charts, cosmic dust streams, and prismatic beams unchanged, ensure the lotus casts warm highlights and seamlessly integrates with the sceneâ€™s lighting."
        ]
      },
      "aspect_ratio": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "description": "Text prompt describing the image, what you want the final edited image to look like.",
        "examples": [
          "Replace the glowing amethyst flame at the towerâ€™s peak with a levitating orb of swirling turquoise water, keeping the spiral tower, crystalline desert, floating shards, and aurora-lit sky unchanged; ensure the water orb emits cool reflections and integrates naturally with the existing lighting."
        ]
      },
      "aspect_ratio": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "description": "Text prompt describing the image, what you want the final edited image to look like.",
        "examples": [
          "Add a tiny blue knitted scarf around the kittenâ€™s neck, keep the kittenâ€™s pose, table, lighting, and cozy indoor environment unchanged; make the scarf soft and cute, fitting naturally without covering the kittenâ€™s face."
        ]
      },
      "aspect_ratio": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "description": "Text prompt describing the image, what you want the final edited image to look like.",
        "examples": [
          "Add a small red bow tie around the puppyâ€™s neck, slightly fluffy fabric texture, keep the puppyâ€™s pose, facial expression, sofa, lighting, and living room environment unchanged; ensure the bow tie matches the warm lighting and looks naturally placed."
        ]
      },
      "aspect_ratio": {
        "type": "string",
...
,
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        "examples": [
          "Add a tiny blue knitted scarf around the kittenâ€™s neck."
        ],
        "description": "Text prompt describing the image, what you want the final edited image to look like.",
        "type": "string",
        "title": "Prompt",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        "examples": [
          "Add a small red bow tie around the puppyâ€™s neck."
        ],
        "description": "Text prompt describing the image, what you want the final edited image to look like.",
        "type": "string",
        "title": "Prompt",
  ...
  },
  {
    ...
    "inputs": {
      ...
      "images_list": {
        ...
        "description": "1â€“3 reference photos of the character to build the sheet from.",
        "field": "images_list",
        "type": "array",
        "items": {
          "type": "string"
...
// Auto-generated from schema_data.json â€” Image to Video models
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "description": "Text prompt describing the desired video content.",
        "examples": [
          "A spaceship hovers over Earth. A digital billboard beams out: 'MuAPI is broadcasting creativity across the galaxy.' A robot host floats in zero gravity holding a prompt card: 'Letâ€™s turn this into a story.' Suddenly, video panels fly around the ship with generated content."
        ]
      },
      "aspect_ratio": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "description": "The prompt to be used to generate a video",
        "examples": [
          "The camera smoothly zooms in on the sleek, futuristic race car as it speeds through a neon-lit urban tunnel at twilight, its glossy white surface reflecting the vibrant pink and blue lights streaking past. The precise detailing of the carâ€™s aerodynamic curves and glowing accents is highlighted as droplets of water spray from the spinning tires, adding a palpable sense of motion and intensity. The driverâ€™s black helmet, contrasted against the carâ€™s gleaming body, remains sharply in focus, emphasizing the thrilling high-speed chase through the city. The blurred cityscape and illuminated digital billboards in the background create a high-tech, cyberpunk atmosphere, intensifying the sceneâ€™s adrenaline and futuristic vibe."
        ]
      },
      "aspect_ratio": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "description": "The prompt to generate the video",
        "examples": [
          "A cat dressed in a sharp business suit stands confidently on a TED Talk stage, delivering an engaging lecture on quantum physics. The audience is filled with attentive dogs wearing glasses, reacting thoughtfully to the presentation. The video features dramatic camera zooms that highlight the cat speakerâ€™s expressions and the intrigued faces of the canine audience, maintaining the setting and characters without altering the scene."
        ]
      },
      "aspect_ratio": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "description": "Text prompt describing the video.",
        "examples": [
          "Transform this still image into a dramatic cinematic sequence: the scholar walks slowly through an ancient library where shelves tower endlessly into the shadows. The lanternâ€™s flame flickers, casting moving patterns across scrolls and statues. Dust motes dance in golden light as the camera glides smoothly behind him, then pans upward to reveal an infinite expanse of glowing constellations painted across the ceiling that begin to shimmer and move as if alive."
        ]
      },
      "duration": {
        "type": "int",
  ...
  },
  {
    ...
    "inputs": {
      ...
      "prompt": {
        ...
        "description": "The prompt to generate the video",
        "examples": [
          "Animate the scene: camera slowly dollies forward toward the robot, neon city lights begin to flicker, soft reflections shift across the dome glass, twilight deepens into night with subtle ambient glow. The robot raises its head and speaks in a clear futuristic voice: â€˜WAN 2.5 is now available on the MuAPI app.â€™"
        ]
      },
      "resolution": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      ...
      "prompt": {
        ...
        "description": "The prompt to generate the video",
        "examples": [
          "The camera slowly pulls back from the portrait, revealing the rooftop garden swaying in the breeze, clouds drifting across the orange-pink sky. The city lights begin to flicker on in the distance as the sun sets. She gazes at the horizon and softly says: â€œEvery ending feels like the start of something new.â€ Natural ambient sounds of wind and faint city life in the background."
        ]
      },
      "resolution": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "description": "The prompt to generate the video",
        "examples": [
          "Camera pans along the platform as the bullet train doors open, passengers step forward with rolling suitcases. Footsteps and soft chatter fill the air. A female announcer says: â€˜Train number 2245 to Tokyo is now departing from platform 3.â€™ Wheels screech lightly as the train starts moving."
        ]
      },
      "aspect_ratio": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "description": "Text prompt describing the video.",
        "examples": [
          "Scene: Lantern festival by the river at night.\nCharacters: Young boy with his grandmother.\nAction: Camera starts behind them â†’ tracks one lantern downstream â†’ lift to sky full of lights.\nLighting: Warm candlelight vs cool night reflections.\nAudio: Gentle music, water flow.\nDialogue:\nGrandmother: â€œEvery lantern carries a wish.â€\nBoy: â€œThen mineâ€™s for you to stay forever.â€\nGrandmother (smiling): â€œIâ€™ll be right there, glowing among them.â€"
        ]
      },
      "aspect_ratio": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "description": "The prompt to generate the video",
        "examples": [
          "The cyberpunk samurai turns slowly toward the camera, raindrops gliding off his glowing armor, neon lights reflecting on wet metal, camera pans around him in a slow 360Â°, subtle lightning flashes illuminate the skyline."
        ]
      },
      "resolution": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      ...
      "prompt": {
        ...
        "description": "The prompt to generate the video",
        "examples": [
          "The female explorer walks slowly across the alien terrain, crystals glimmering around her. The camera glides beside her as light from twin suns scatters across her reflective suit. Wind stirs the mist as she looks up toward the horizon, where a colossal planet looms above â€” evoking awe and wonder."
        ]
      },
      "resolution": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "description": "The prompt to generate the video",
        "examples": [
          "The camera begins behind the traveler standing amid the misty ancient ruins. Leaves swirl in the air as golden light flickers. A surge of energy surrounds the traveler â€” ruins start to dissolve into bright particles. The environment morphs into a neon-lit futuristic city as the traveler continues walking forward, entering the new world."
        ]
      },
      "resolution": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "description": "The prompt to generate the video",
        "examples": [
          "Camera begins behind the cabin as snowflakes drift through pale dawn light. Warm sunlight pierces the mist â€” the snow slowly melts, trees turn green, and the ground blossoms with flowers. The air brightens into a spring sunrise as birds take flight over the cabin, symbolizing rebirth and renewal."
        ]
      },
      "resolution": {
        "type": "string",
  ...
  },
  {
    ...
    "inputs": {
      ...
      "prompt": {
        ...
        "description": "Text prompt describing the video.",
        "examples": [
          "A high-speed train races forward nonstop while the environment transforms every few secondsâ€”from snowy mountains to neon cyberpunk city to volcanic wasteland. Sparks fly from the tracks as the camera stays tightly locked alongside the speeding train during each violent world transition."
        ]
      },
      "aspect_ratio": {
        "type": "string",
...
,
  ...
  },
  {
    ...
    "inputs": {
      ...
      "images_list": {
        ...
        "description": "Upload up to 9 image URLs. Reference them in the prompt using @image1, @image2, â€¦ @image9.",
        "field": "images_list",
        "type": "array",
        "items": {
          "type": "string"
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "title": "Prompt",
        "name": "prompt",
        "description": "Video description. Use @image1â€¦@image9 to reference images, @video1â€¦@video3 for videos, @audio1â€¦@audio3 for audio. To use a fictional character, reference it with @character:<id> (request_id from a completed Seedance 2 Character generation) â€” characters are automatically appended to images_list. Multiple characters are supported."
      },
      "images_list": {
        "examples": [
          "https://d3adwkbyhxyrtq.cloudfront.net/webassets/videomodels/seedance-v2.0-omni-reference.png"
      ...
      "duration": {
        ...
        "title": "Duration (seconds)",
        "name": "duration",
        "description": "Video duration in seconds (8â€“15).",
        "default": 8,
        "minValue": 8,
        "maxValue": 15,
        "step": 1
  ...
  },
  {
    ...
    "inputs": {
      ...
      "images_list": {
        ...
        "description": "1 image uses it as the start frame (first_last_frames mode). 2â€“9 images switches to omni_reference mode â€” reference them in your prompt with @image1, @image2, etc.",
        "field": "images_list",
        "type": "array",
        "items": {
          "type": "string"
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "title": "Prompt",
        "name": "prompt",
        "description": "Video description. Use @image1â€¦@image9 to reference images and @audio1â€¦@audio3 for audio. To use a character sheet, reference it with @character:<request_id> (from a completed Seedance 2 Character generation). To use a trained Omni Reference character, reference it with @omni-character:<character_id> where character_id is the value returned by Omni Reference Train Character (e.g. char_1775422630065_4vbana). Both methods can be combined in the same prompt. Multiple characters are supported. Example: '@omni-character:char_1775422630065_4vbana walking through a neon-lit city at night'.",
        "examples": [
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "title": "Prompt",
        "name": "prompt",
        "description": "Video description. Use @image1â€¦@image9 to reference images, @video1â€¦@video3 for videos, and @audio1â€¦@audio3 for audio. Use @character:<request_id> for a Seedance 2 character sheet or @omni-character:<char_id> for a trained Kinovi character. Multiple characters are supported.",
        "examples": [
          "@image1 is the main character. The person walks along a city street at sunset, cinematic lighting."
        ]
      },
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        "examples": [
          "Dark smoke begins leaking from the womanâ€™s body and rapidly expands outward. Her form dissolves into swirling vapor while glowing eyes emerge from the smoke cloud. The alley fills with violent rotating smoke as the camera circles aggressively around the transformation."
        ],
        "description": "Text prompt describing the transition.",
        "type": "string",
        "title": "Prompt",
  ...
  },
  {
    ...
    "inputs": {
      "prompt": {
        ...
        "examples": [
          "The suitcase opens by itself and tiny landscapes start unfolding out of itâ€”mountains, forests, oceans, entire cities. Each world expands outward onto the platform, growing larger and larger while miniature weather systems form above them."
        ]
      },
      "image_urls": {
        "field": "images_list",
        ...
        "title": "Reference Images",
        "name": "image_urls",
        "description": "Upload 1â€“7 reference images for the video. Maximum 20 MB each.",
        "examples": [
  ...
  },
  {
    ...
    "inputs": {
      ...
      "images_list": {
        ...
        "description": "1 image = first frame only; 2 images = first and last frame. Use â€˜adaptiveâ€™ aspect ratio to match the reference image geometry.",
        "field": "images_list",
        "type": "array",
        "items": {
          "type": "string"
      ...
      "aspect_ratio": {
        ...
        "title": "Aspect Ratio",
        "name": "aspect_ratio",
        "description": "Output video aspect ratio. â€˜adaptiveâ€™ matches the reference image (recommended); concrete ratios may crop or pad.",
        "default": "adaptive"
      },
      "duration": {
        "type": "int",
...
// â”€â”€â”€ Video-to-Video models â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
,
...

  {
    ...
    "imageField": "image_url",
    "hasPrompt": true,
    "description": "Bring your characters and worlds to life with AI Dance Effects â€” a creative video effect that adds playful, dynamic, and cinematic motion to your generations.",
    "provider": "muapi",
    "provider_name": "Muapi"
  },
  {
  ...
  },
  {
    ...
    "description": "Seedance v1.5 Pro Video Extend continues an existing video by generating additional frames that match the original sceneâ€™s style, lighting, motion, and mood.",
    "provider": "bytedance",
    "provider_name": "ByteDance"
  },
  {
  ...
  },
  {
    ...
    "videoField": "video_url",
    "hasPrompt": false,
    "description": "ðŸŽ‰ FREE for a limited time â€” Remove SD 2.0 watermarks from videos using LaMa AI inpainting.",
    "provider": "bytedance",
    "provider_name": "ByteDance"
  },
  {
  ...
  },
  {
    ...
    "promptRequired": true,
    "inputs": HAPPY_HORSE_EDIT_INPUTS,
    "description": "Happy Horse 1.1 Video Edit (1080p) â€” modify an input video using natural-language instructions with optional reference images.",
    "provider": "happy-horse",
    "provider_name": "Happy Horse"
  },
  {
    ...
    "promptRequired": true,
    "inputs": HAPPY_HORSE_EDIT_INPUTS,
    "description": "Happy Horse 1.1 Video Edit (720p) â€” modify an input video using natural-language instructions with optional reference images.",
    "provider": "happy-horse",
    "provider_name": "Happy Horse"
  },
  {
    ...
    "hasPrompt": true,
    "promptRequired": true,
    "description": "Gemini Omni Video Edit â€” natively multimodal video-to-video editing.",
    "provider": "google",
    "provider_name": "Google"
  },
  {
...
// â”€â”€â”€ LipSync / Speech-to-Video models â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Image-based: portrait image + audio â†’ talking video
// Video-based: existing video + audio â†’ lipsync video
export const lipsyncModels = [
  // â”€â”€ Image + Audio â†’ Video â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  {
  ...
  // â”€â”€ Video + Audio â†’ Video â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  {
    "id": "sync-lipsync",
    "name": "Sync Lipsync",
...
// â”€â”€â”€ Recast / Body Swap models â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Source video (the performance / motion) + character image (the new identity)
// â†’ a video of the new character performing the source video's motion.
export const recastModels = [
  ...
  },
  {
    ...
    "description": "Recast any character â€” drive a character image with the motion and performance from your video."
  }
,
  {
...
// â”€â”€â”€ Motion Control Models (Seedance) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€ Audio Models â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
export const audioModels = [
  {
    ...
    "family": "suno",
    "description": "Suno generate music that turns text prompts into full songs Î“Ã‡Ã¶ complete with vocals, lyrics, and instrumentation. You can describe a mood, genre, or even a specific lyric idea, and Suno creates a realistic, studio-quality track in seconds.",
    "required": [
      "style"
    ],
    "inputs": {
      ...
      "style_weight": {
        ...
        "name": "style_weight",
        "type": "int",
        "description": "Strength of adherence to the specified style (optional). Range 0Î“Ã‡Ã´1, up to 2 decimal places.",
        "minValue": 0,
        "maxValue": 1,
        "step": 0.05,
        "default": 0.65
      ...
      "weirdness_constraint": {
        ...
        "type": "int",
        "description": "Controls experimental/creative deviation (optional). Range 0Î“Ã‡Ã´1, up to 2 decimal places.",
        "minValue": 0,
        "maxValue": 1,
        "step": 0.05,
        "default": 0.65
      ...
      "audio_weight": {
        ...
        "name": "audio_weight",
        "type": "int",
        "description": "Balance weight for audio features vs. other factors (optional). Range 0Î“Ã‡Ã´1, up to 2 decimal places.",
        "minValue": 0,
        "maxValue": 1,
        "step": 0.05,
        "default": 0.65
  ...
  },
  {
    ...
    "family": "minimax-2.3",
    "description": "Minimax Voice Clone creates a high-fidelity digital clone of a speakerÎ“Ã‡Ã–s voice from a short reference audio sample. It reproduces the speakerÎ“Ã‡Ã–s tone, emotion, accent, rhythm, and speaking style, then generates new speech from any text input.",
    "required": [
      "audio_url",
      "custom_voice_id"
    ],
  ...
  },
  {
    ...
    "family": "minimax-2.6",
    "description": "Speech-2.6-hd is MinimaxÎ“Ã‡Ã–s high-definition text-to-speech model that turns written text into natural, human-like audio. It produces studio-quality speech with clear pronunciation, smooth pacing, realistic emotion, and no background noise.",
    "required": [
      "prompt",
      "voice_id"
    ],
    "inputs": {
      ...
      "voice_id": {
        "enum": [
          ...
          "Arabic_CalmWoman",
          "Arabic_FriendlyGuy",
          "Cantonese_ProfessionalHostâˆ©â•ÃªF)",
          "Cantonese_GentleLady",
          "Cantonese_ProfessionalHostâˆ©â•ÃªM)",
  ...
  },
  {
    ...
    "family": "minimax-2.6",
    "description": "Speech-2.6-turbo is MinimaxÎ“Ã‡Ã–s fast, lightweight text-to-speech model designed for quick audio generation while maintaining good natural voice quality. It produces clear speech with smooth pacing and minimal delay.",
    "required": [
      "prompt",
      "voice_id"
    ],
  ...
  },
  {
    ...
    "inputs": {
      ...
      "voice_id": {
        ...
        "enum": [
          {"label": "James â€” Husky, Engaging and Bold", "value": "ZQe5CZNOzWyzPSCn5a3c"},
          {"label": "Arabella â€” Mysterious and Emotive", "value": "Z3R5wn05IrDiVCyEkUrK"},
          {"label": "Bradford â€” Expressive and Articulate", "value": "NNl6r8mD7vthiJatiJt1"},
          {"label": "Xavier â€” Dominating, Metallic Announcer", "value": "YOq2y2Up4RgXP2HyXjE5"},
          {"label": "Taksh â€” Calm, Serious and Smooth", "value": "qDuRKMlYmrm8trt5QyBn"},
          {"label": "Monika Sogam â€” Deep and Natural", "value": "iP95p4xoKVk53GoZ742B"},
          {"label": "Mark â€” Casual, Relaxed and Light", "value": "UgBBYS2sOqTuMpoF3BR0"},
          {"label": "Adeline â€” Feminine and Conversational", "value": "5l5f8iK3YPeGga21rQIX"},
          {"label": "Sam â€” Support Agent", "value": "yoZ06aMxZJJ28mfd3POQ"},
          {"label": "Spuds Oxley â€” Wise and Approachable", "value": "NOpBlnGInO9m6vDvFkFC"},
          {"label": "Eve â€” Authentic, Energetic and Happy", "value": "scOwDtmlLZohaFMFCHFe"},
          {"label": "Callum â€” Husky Trickster", "value": "N2lVS1w4EtoT3dr4eOWO"},
          {"label": "Laura â€” Enthusiast, Quirky Attitude", "value": "FGY2WhTYpPnrIDTdsKH5"},
          {"label": "Brian â€” Deep, Resonant and Comforting", "value": "zPhCVfO2NBER7bRLIdbq"},
          {"label": "Nathan â€” Virtual Radio Host", "value": "nPczCjzI2devNBz1zQrb"},
          {"label": "Charlie â€” Natural", "value": "IKne3meq5aSn9XLyUdCD"},
          {"label": "George â€” Warm", "value": "JBFqnCBsd6RMkjVDRZzb"},
          {"label": "Sarah â€” Soft", "value": "EXAVITQu4vr4xnSDxMaL"},
          {"label": "Charlotte â€” Clear", "value": "XB0fDUnXU5powFXDhCwa"},
          {"label": "Hope â€” Bubbly, Gossipy and Girly", "value": "tnSpp4vdxKPjI9w0GnoV"},
          {"label": "Finn â€” Youthful, Eager and Energetic", "value": "DYkrAHD8iwork3YSUBbs"},
          {"label": "Tom â€” Conversations and Books", "value": "56AoDkrOh6qfVPDXZ7Pt"},
          {"label": "Lucy â€” Fresh and Casual", "value": "lcMyyd2HUfFzxdCaC4Ta"},
          {"label": "Tiffany â€” Natural and Welcoming", "value": "6aDn1KB0hjpdcocrUkmq"},
          {"label": "Brock â€” Commanding and Loud Sergeant", "value": "7ftFdxRlmR6Z9V3nTdUh"},
          {"label": "Viraj â€” Rich and Soft", "value": "bajNon13EdhNMndG3z05"}
        ]
      },
      "stability": {
        "type": "number",
